...
class ControllerQuestionVoc extends Controller
{
    // Função para Criar Questões do Questionário Vocacional
    public function CriarQuestionVoc(Request $req){
    ...
    public function ListarQuestsVoc(){
    ...
    public function EditarQuestionVoc($id){
    ...
    public function AtualizarQuest(Request $req, $id_pergunta){
    ...
    public function ExcluirQuestionVoc($id_pergunta)
    {
    ...
    public function ResponderQuestsVoc(Request $request){
    ...
    public function VisualizarResultadoQuestionario($maior_inteligencia){
        ...
        return view('resultQuestionario', compact('resultado'));
