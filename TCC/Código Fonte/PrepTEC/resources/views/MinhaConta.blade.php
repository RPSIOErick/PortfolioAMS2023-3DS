            ...
            <!-- Sidebar esquerdo -->
                <div id="sidebar">
                    ...
                    <!-- Dados do Usuário -->
                        ...
                        <div id="profile-picture">
                            ...
                            @else
                                ...
                                <img src="/img/img-Profile-placeholder.png" alt="Foto do perfil">
                    ...
                    <div id="row-menu">
                        ...
                        <!-- <a href="#"><img src="img\settings.png" id="icons-sidebar"/>Gerenciar Sistema</a>
                        <hr>
                        <a href="#"><img src="img\exit.png" id="icons-sidebar"/>Sair da Conta</a> -->
                ...
                <div id="content">
                            ...
                            <!-- navbar menor (onde fica o perfil e menu) -->
                                <nav class="navbar navbar-dark fixed-top" id="sidebar-right">
                                    ...
                                    @if(!empty($conta->fotoUsuario))
                                        ...
                                        <img src="{{ asset('storage/users/'. $conta->fotoUsuario) }}" alt="Foto do perfil" id="img-profile" onclick="window.location='/'">                                        
                                    
                                    @else

                                        <img src="/img/userIcon.png" alt="Foto do perfil" id="img-profile">
                    ...
                    <div class="row" id="row-form">
                        ...
                        @if(Session::has('Sucesso'))
                            <div class="alert alert-success" style="width: 53vw; margin-bottom: 2vw;">{{Session::get('Sucesso')}}</div>
                        @endif
