...
@section('content')
<head>
    <link rel="stylesheet" href="/css/infoVest.css">
                                    ...
                                    <div class="col" id="d-part1-exp-column">
                                        ...
                                        <!--Texto Etec-->
                                            <p id="txt-part1-exp-etec">
                                                ...
                                                essas escolas são financiadas pelo Centro Estadual de Educação do Estado de São Paulo, 
                                                em associação com o Centro Paula Souza. 
                                                Sendo seu objetivo é proporcionar aos alunos uma preparação abrangente para a vida profissional
                                            </p>
                                        <!--Fim do Texto Etec-->
                                        ...
                                        <!--Texto Vestibulinho-->
                                            <p id="txt-part1-exp-vest">
                                                ...
                                                o Vestibulinho Etec é um processo seletivo para ingresso nas Escolas Técnicas Estaduais (Etecs) 
                                                por meio de um exame de múltipla escolha, 
                                                voltado para estudantes que estão cursando o 9º ano do Ensino Fundamental 
                                    ...
                                    <div id="d-part2-yp-exp-ams">
                                        ...
                                        <!--Explicação do AMS-->
                                            <p id="txt-part2-yp-exp">
                                                ...
                                                Se desejar, sem Vestibular, é possível fazer um curso superior de tecnologia do mesmo eixo tecnológico, 
                                                que será concluído em mais dois anos.
                                            </p>
