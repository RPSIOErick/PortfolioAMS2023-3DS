...
Route::get('/simulado/listar', [ControllerAdministrador::class, 'ListarQuestoesSimu']);

Route::get('/simulado/cadastrar', function () {
    return view('admin/gerenciarSimulado/cadastrarSimulado');
});

Route::get('/simulado/editar', function () {
    return view('admin/gerenciarSimulado/editarSimulado');
});
...
Route::post('/questoes_sim/salvar', [ControllerAdministrador::class, 'SalvarQuestoes']);
Route::get('/simulado/editar/{id_quest}', [ControllerAdministrador::class, 'EditarSimulado']);
Route::put('/simulado/atualizar/{id_quest}', [ControllerAdministrador::class, 'AtualizarQuestoes']);
